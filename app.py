...
def add_watermark(image_bytes: bytes, is_premium: bool = False, watermark_text: str = "DreamAI") -> bytes:
    ...
    try:
        ...
        if not is_premium:
            ...
            # Draw with 60% opacity (alpha = 153 out of 255) with stroke for better quality
            overlay_draw.text((center_x, center_y), center_text, fill=(255, 255, 255, 153), font=center_font, stroke_width=3, stroke_fill=(0, 0, 0, 180))
        ...
        # Draw text with 100% opacity (white text, no background) with stroke for better quality
        overlay_draw.text((bottom_x, bottom_y), bottom_text, fill=(255, 255, 255, 255), font=bottom_font, stroke_width=2, stroke_fill=(0, 0, 0, 200))
